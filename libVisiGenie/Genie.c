...
//      This is intended to be used with the Propeller 
//
//   Ported to Propeller GCC by
//   Jon Shaulis (mscreations), November 2013, <jon@mscreations.net>
//
//   Based on code from genieArduino
//
//    Updated by
...
/*********************************************************************
 * This file is part of genieProp:
 *    genieProp is free software: you can redistribute it and/or modify
 *    it under the terms of the GNU Lesser General Public License as
 *    published by the Free Software Foundation, either version 3 of the
 *    License, or (at your option) any later version.
 *
 *    genieProp is distributed in the hope that it will be useful,
 *    but WITHOUT ANY WARRANTY; without even the implied warranty of
 *    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 *    GNU Lesser General Public License for more details.
 *
 *    You should have received a copy of the GNU Lesser General Public
 *    License along with genieProp.
...
//
// TODO: NEED TO VERIFY THIS FUNCTION ISN'T TAKING LONGER THAN NECESSARY.
